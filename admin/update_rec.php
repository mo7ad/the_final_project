...
<form class="form" method="post">
    ...
    <div class="form-container">
        ...
        <textarea class="form-control" class="input" name="url" placeholder="Picture link" ><?= $row["url"] ?></textarea>
        <textarea class="form-control" class="input" name="description" placeholder="Cooking Description" ><?= $row["description"] ?></textarea>
        <textarea class="form-control" class="input" name="ingredients" placeholder="Ingredients" ><?= $row["ingredients"] ?></textarea>
