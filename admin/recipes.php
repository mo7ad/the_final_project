    ...
    while ($row = mysqli_fetch_assoc($result)) {
        $layout .=
            ...
            <div class='card h-100 shadow'>
                <img src='{$row["url"]}' class='card-img-top' style='object-fit: cover; height: 240px; width:180px;' alt=''>
                <div class='card-body'>
                ...
                <a href='../home_user/details.php?id={$row["recipes_id"]}' class='btn btn-outline-danger'>Details</a> </div>
